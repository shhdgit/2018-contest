...
function turnLeft(matrix) {
  ...
  for (var _i = 1; _i <= x; _i++) {
    for (var j = 0; j < y; j++) {
      tempMatrix[x - _i][j] = matrix[j][_i - 1];
    }
  }
...
function turnRight(matrix) {
  ...
  for (var _i2 = 1; _i2 <= x; _i2++) {
    for (var j = 0; j < y; j++) {
      tempMatrix[_i2 - 1][y - j - 1] = matrix[j][_i2 - 1];
    }
  }
...
function turnBack(matrix) {
  ...
  for (var _i3 = 1; _i3 <= x; _i3++) {
    for (var j = 0; j < y; j++) {
      tempMatrix[y - j - 1][x - _i3] = matrix[j][_i3 - 1];
    }
  }
...
var Game = function () {
  function Game() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { size: 4 },
        size = _ref.size;
  ...
  _createClass(Game, [{
    key: 'init',
    value: function init() {
      this.matrix = new _matrix.Matrix(this._size, this._size);
      this.status = {
        win: false,
        score: 0,
        max: 2
    ...
    value: function move(direction) {
      ...
      var randomNumber = Math.random() > .7 ? 4 : 2;
    ...
    value: function zip() {
      ...
      for (var _i = 0; _i < this._size; _i++) {
        newArr[_i] = new Array(this._size).fill(0);
      }

      this.matrix.array.forEach(function (row, i) {
      ...
      for (var i = 0; i < this._size; i++) {
        for (var j = 0; j < this._size; j++) {
          if (j < this._size - 1 && this.matrix.array[i][j] === this.matrix.array[i][j + 1]) {
            var score = this.matrix.array[i][j] * 2;
    ...
    key: 'setRandomBlock',
    value: function setRandomBlock(num) {
      var emptyRow = this.getRandomEmptyRow();
    ...
    key: 'haveEmptyBlock',
    value: function haveEmptyBlock() {
      return this.matrix.array.some(function (innerArr) {
        return innerArr.some(function (item) {
          return item === 0;
        });
      });
    }
  }, {
    key: 'getRandomEmptyRow',
    value: function getRandomEmptyRow() {
    ...
    key: '_getEmptyRow',
    value: function _getEmptyRow(rowNumber) {
      var row = this.matrix.array[rowNumber];
    ...
    key: '_setEmptyBlock',
    value: function _setEmptyBlock(row, num, index) {
      if (row[index] === 0) {
        row[index] = num;
      } else {
        row.some(function (rowNum, i) {
          if (rowNum === 0) {
            row[i] = num;
            return true;
          }
    ...
    value: function _getRandomNumber() {
...
exports.default = {
  ...
  data: function data() {
    return {};
      ...
      var $c6bbf6 = exports.default || module.exports;
      if (typeof $c6bbf6 === 'function') {
        $c6bbf6 = $c6bbf6.options;
      }
    
        /* template */
        Object.assign($c6bbf6, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "block" }, [
    _vm.num ? _c("span", [_vm._v(_vm._s(_vm.num))]) : _vm._e()
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c6bbf6', $c6bbf6);
          } else {
            api.reload('$c6bbf6', $c6bbf6);
          }
        }
...
var _gameCore = require('game-core');

var _block = require('./components/block.vue');
...
exports.default = {
  ...
  methods: {
    ...
    addKeyboardListener: function addKeyboardListener() {
      ...
      this.keyboardListener = function (e) {
        var direction = _this.keyCodeMap[e.keyCode];

        if (direction) _this.game.move(direction);
      };

      document.addEventListener('keyup', this.keyboardListener);
    },
    removeKeyboardListener: function removeKeyboardListener() {
      document.removeEventListener('keyup', this.keyboardListener);
    },
    restart: function restart() {
      this.game = new _gameCore.Game();
  ...
  destroyed: function destroyed() {
    this.removeKeyboardListener();
      ...
      var $4001b7 = exports.default || module.exports;
      if (typeof $4001b7 === 'function') {
        $4001b7 = $4001b7.options;
      }
    
        /* template */
        Object.assign($4001b7, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "scene-wrap" }, [
    _c("div", { staticClass: "status-bar" }, [
      _c("span", [_vm._v("分数：" + _vm._s(_vm.game.status.score))]),
      _vm._v(" "),
      _c("div", [
    ...
    _c(
      ...
      _vm._l(_vm.matrix.array, function(row, index1) {
        return _c(
          "div",
          { key: index1 },
          _vm._l(row, function(num, index2) {
            return _c("Block", {
    ...
    _vm._v(" "),
    _c("h3", { staticClass: "tips" }, [_vm._v("PC端键盘控制，移动端滑动控制")])
  ])
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4001b7', $4001b7);
          } else {
            api.reload('$4001b7', $4001b7);
          }
        }
...
var _alloy_finger = require('alloyfinger/vue/alloy_finger.vue');
...
_vue2.default.use(_alloy_finger2.default, {
  AlloyFinger: _alloyfinger2.default
});
